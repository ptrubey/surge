...
slosh = read.csv(gzfile('~/git/projgamma/datasets/slosh/slosh_crt_data.csv.gz'))
locdata = slosh[,1:8]
raw = t(slosh[,-c(1:8)])
# Relevant Locs: 
# - (5) Dover AFB
# - (10) Philadelphia Intl. Airport
#----------------------------------
#  Delaware Map
#----------------------------------
...
#---------------------------------
# mc_alphas = read.csv(gzfile('~/git/projgamma/datasets/slosh/crt/mc_alphas.csv.gz'))
